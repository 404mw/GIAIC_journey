...
let current_users: string[] = ["Mapus", "Adrian", "Blank", "James", "Classic", "Komgen"]
let new_users: string[] = ["Onteo", "Spilph", "Komgen", "Believer", "Adrian"]
...
for (let i = 0; i < new_users.length; i++) {
    ...
    if (current_users_lowercase.includes(newUser.toLowerCase())) {
        console.log(`The username '${newUser}' is already taken. Kindly enter a new username.`);
    } else {
